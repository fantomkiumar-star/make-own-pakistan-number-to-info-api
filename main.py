...
#!/usr/bin/env python3
"""
pak_number_api_live_final_emoji.py

- Pakistan Number/CNIC info API
- GET / POST supported
- Mobile (92...) and CNIC (13 digits)
- Copyright with emoji: 👉🏻 @Temp_Sketch
- Pretty JSON optional via ?pretty=1
"""
...
COPYRIGHT_HANDLE = os.getenv("COPYRIGHT_HANDLE", "@Temp_Sketch")
